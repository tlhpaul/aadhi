...
Usage:
 ...
 7. Enabled caching using memcached. All the reqeust url and response would be caused while we regarding the stubs using        proxy mode. This gives excellent performance while responding to automation devices while running in server mode
